...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            link = "[Here](https://t.me/MarshelloSupport)"
            ...
            ftext += "--------BEGIN Marsmello USERBOT TRACEBACK LOG--------"
            ftext += "\nDate: " + date
...
def load_assistant(shortname):
    if shortname.startswith("__"):
        ...
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        print("Initialising marshmello3.")
        print("Marshmello - Imported " + shortname)
    else:
        import importlib
        import sys
        from pathlib import Path
        ...
        print("marshmello Has imported " + shortname)
