...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/793b65ef7de7af43d3e00.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/793b65ef7de7af43d3e00.jpg"
else:
    CAT_IMG = CAT_IMGE
...
hellversion = "7.0"
# 🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "𝕄𝕒𝕣𝕤𝕙𝕞𝕖𝕝𝕝𝕠"
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        ...
        return
    req = requests.get("https://telegra.ph/file/793b65ef7de7af43d3e00.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ ̷M̷̷A̷̷R̷̷S̷̷H̷̷M̷̷E̷̷L̷̷L̷̷O̷ ](https://t.me/MarshelloSupport)\n"
            "[̷M̷̷A̷̷R̷̷S̷̷H̷̷M̷̷E̷̷L̷̷L̷̷O̷](https://t.me/MarshelloSupport)",
            link_preview=False,
        )
        await salive.delete()
